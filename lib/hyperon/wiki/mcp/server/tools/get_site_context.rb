      ...
      module Server
        module Tools
          ...
          class GetSiteContext < ::MCP::Tool
            description "Get Hyperon Wiki wiki structure, hierarchy, and content placement guidelines. Call this FIRST when starting work to understand where content belongs and how the wiki is organized. Essential for AI agents to navigate the wiki effectively."
