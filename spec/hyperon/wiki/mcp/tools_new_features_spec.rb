...
RSpec.describe Hyperon::Wiki::Mcp::Tools, "new features" do
  before do
    ...
    let(:backups_list) do
      {
        "backups" => [
          {
            "filename" => "hyperon_wiki_backup_20251203_120000.sql",
            "size" => 12345678,
            "size_human" => "11.77 MB",
            "age" => "2 hours ago"
          }
  ...
  describe "#download_database_backup_file" do
    let(:filename) { "hyperon_wiki_backup_20251203_120000.sql" }
    let(:backup_content) { "-- SQL DUMP" }
